package upc.edu.superherocompose.ui.home
...
import upc.edu.superherocompose.ui.herodetail.HeroDetail
import upc.edu.superherocompose.ui.herolist.Search
...
fun Home() {
    ...
    NavHost(navController = navController, startDestination = Routes.Search.route) {
        ...
        composable(
            ...
            arguments = listOf(
                navArgument(Routes.Detail.argumentId) {
